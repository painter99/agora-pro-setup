# Skill: Memory Audits and Failure Modes

## Catalog description

Audit cycles, contradiction handling, and known memory failure modes.

> Install this file into Agora **Saved Skills** (flat name, no directories).
> The body below is the operational contract. `Memory Audits and Failure Modes` in the Skill Catalog should stay short.
